...
class Grades:
    """
    A data structure for project grades, along with formatting code to display
    them
    """
    ...
    def __init__(self, projectName, questionsAndMaxesList,
        ...
        Defines the grading scheme for a project
          ...
          questionsAndMaxesDict: a list of (question name,
    ...
    def grade(self, gradingModule, exceptionMap={}, bonusPic=False):
        ...
        for q in self.questions:
            ...
            if len(incompleted) > 0:
                ...
                print("""*** NOTE: Make sure to complete Question %s 
                before working on Question %s, *** because Question %s builds 
                upon your answer for Question %s.""" % (prereq, q, q, prereq))
                continue
        ...
        if bonusPic and self.points.totalCount() == 16:
            print("""
...
""")
    ...
    def addExceptionMessage(self, q, inst, traceback):
        ...
        we need to cgi.escape the traceback but wrap the exception in a <pre>
        tag
        """
    ...
    def produceGradeScopeOutput(self):
        ...
        for name in self.questions:
            ...
            test_out['output'] = "  Question {num} " \
                                 "({points}/{max}) {correct}".format(
