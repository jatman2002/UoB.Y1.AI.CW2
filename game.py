...
class Agent:
    ...
    def getAction(self, state):
        ...
        (from either {pacman, capture, sonar}.py) and
...
class Grid:
    ...
    accessed via grid[x][y] where (x,y) are positions on a Pacman map with
...
class Actions:
    ...
    _directionsAsList = [('West', (-1, 0)), ('Stop', (0, 0)), ('East', (1, 0)),
                         ('North', (0, 1)), ('South', (0, -1))]
            ...
            if self.catchExceptions:
                try:
                    ...
                    if move_time > self.rules.getMoveWarningTime(agentIndex):
                        ...
                        print(
                            "Agent %d took too long to make a move! "
                            "This is warning %d" % (
                                agentIndex,
